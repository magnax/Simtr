...
$person = 1;
$this->redis->set("$key:$person", 'Projekt %s zakończony, %s wyprodukowane i trafia do Twojego ekwipunku');$loaded++;
$this->redis->del("$key:$person:params");
$this->redis->lpush("$key:$person:params", 'amount');$loaded++;
$this->redis->lpush("$key:$person:params", 'name');$loaded++;

$person = 3;
$this->redis->set("$key:$person", 'Projekt %s zakończony, %s wyprodukowane trafia do ekwipunku %s');$loaded++;
$this->redis->del("$key:$person:params");
...
$person = 1;
$this->redis->set("$key:$person", 'Projekt %s zakończony, %s wyprodukowane trafia na ziemię');$loaded++;
$this->redis->del("$key:$person:params");
$this->redis->lpush("$key:$person:params", 'name');$loaded++;
$this->redis->lpush("$key:$person:params", 'amount');$loaded++;
